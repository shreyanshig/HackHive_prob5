 ...
 * @author Shreyanshi
 */
public class AdmitCardControllerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("Inside AdmitCardControllerServlet");
        ...
        {
            ex.printStackTrace();
            System.out.println("Some exception ocuured in AdmitCardControllerServlet"+ex);
